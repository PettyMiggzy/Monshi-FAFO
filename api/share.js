// Simple share redirect - no OG image (using static fallback)
export default async function handler(req, res) {
  const { game = 'arcade', score = '0', name = 'ANON', rank = '' } = req.query;
...
<meta property="og:description" content="MONSHI ARCADE — 24 games, one token, no exit. Beat my score 👇">
